...
from data.location_data import ind_spatial_data, agg_spatial_data, researcher_view_spatial_data
...
def sensor_locations() -> Dict[str, List[AggMetaData | IndMetaData]]:
    location_dict = {
        ...
        'researcher_view_spatial_data': researcher_view_spatial_data
    }
